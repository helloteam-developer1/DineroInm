 ...
 <div class="container">
     <div class="row mb-3 justify-content-center">
         <div class="col-sm-4 mt-3">
             <label for="inputEmail3" class="col-form-label fw-bold"
                 style="font-family: Carot Sans; color: #3C3C3B; font-size: 20px;">INE Frente</label>
             <div class="col-sm-2">
                 @if ($ine_frente)
                             ...
                             <div class="modal-content">
                                 ...
                                 <div class="modal-body">
                                     <img src="{{ $ine_frente->temporaryUrl() }}" width="100%" height="auto"
                                         alt="No se encontró el Ine frente" />
                                 </div>
                                 <div class="modal-footer" style="border: none;">
                                     <button type="button" class="btn btn-Guardar"
                                         style="height: 50px; width: 150px; margin-right: 150px; font-size: 25px"
         ...
         <div class="col-sm-4 mt-3">
             <a class="btn btn-gris" onclick="document.getElementById('getFileIneFrente').click()">Adjuntar
                 archivo</a>
     ...
     <div class="row mb-3 justify-content-center">
         <div class="col-sm-4 mt-3">
             <label for="inputEmail3" class="col-form-label fw-bold"
                 style="font-family: Carot Sans; color: #3C3C3B; font-size: 20px;">INE Reverso</label>
             <div class="col-sm-2">
         ...
         <div class="col-sm-4 mt-3">
             ...
             <input type='file' id="getFileIneReverso" style="display:none" name="ine_reverso"
     ...
     <div class="row mb-3 justify-content-center">
         <div class="col-sm-4 mt-3">
             <label for="inputEmail3" class=" col-form-label fw-bold"
                 style="font-family: Carot Sans; color: #3C3C3B; font-size: 20px;">Comprobante de domicilio</label>
             <div class="col-sm-2">
                 @if ($comp_dom)
                     <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                     ...
                     <div class="modal fade" id="ComproDomicilioIMG" tabindex="-1"
                         aria-labelledby="ComproDomicilioIMG" aria-hidden="true">
                         <div class="modal-dialog">
                             <div class="modal-content">
                                 <div class="modal-header" style="border: none;">
                                     <h1 class="modal-title fs-5" id="ComproDomicilioIMG">COMPROBANTE DE DOMICILIO
                                     </h1>
                                     <button type="button" class="btn-close" data-bs-dismiss="modal"
                                         aria-label="Close"></button>
                                 </div>
     ...
     <div class="row mb-3 justify-content-center">
         <div class="col-sm-4 mt-3">
             <label for="inputEmail3" class="col-form-label fw-bold"
                 style="font-family: Carot Sans; color: #3C3C3B; font-size: 20px;">Foto con INE</label>
             <div class="col-sm-2">
                 @if ($foto_cine)
                     <button type="button" class="btn btn-primary" data-bs-toggle="modal"
