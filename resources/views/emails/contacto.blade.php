          ...
          <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
            <tr>
              <td style="padding:40px 30px 30px 30px;text-align:center;font-size:24px;font-weight:bold;">
                <a href="www.dineroinmediato.mx" style="text-decoration:none;"><img src="{{asset('img/logo.png')}}" width="165" style="width:165px;max-width:80%;height:auto;border:none;text-decoration:none;color:#ffffff;"></a>
            ...
            <tr>
              <td style="padding:0px 30px 11px 30px;font-size:0;background-color:#ffffff;border-bottom:1px solid #f0f0f5;border-color:rgba(201,201,207,.35);">
                <div class="col-lge" style="display:inline-block;width:100%;max-width:395px;vertical-align:top;padding-bottom:20px;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
                  <p style="margin-top:-10px;margin-bottom:12px;">Contacto </p>
                  <p style="margin-top:0;margin-bottom:18px;">Emeail: <b>{{$contacto['email']}}</b></p>
                  <div>
                      <p style="margin-top:0;margin-bottom:18px;  word-break:break-all; display:flex;">Comentario: <b>{{$contacto['comentario']}}</b></p>                  
                  </div>
                </div>
              </td>
            </tr>
